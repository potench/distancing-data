...
1.  **Open the source code and start editing!**
    ...
    Open the `distancing-data` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
...
prod: https://www.distancingdata.com
stage: tbd
